<template>
    ...
    <div class="track-container">
      <span class="range-value min">{{ minValue}} </span> <span class="range-value max">{{ maxValue }} Mdh</span>
...
export default {
  ...
  methods: {
    ...
    setTrackHightlight(){
      this.$refs.trackHighlight.style.left = this.valueToPercent(this.minValue / 10) + '%'
      this.$refs.trackHighlight.style.width = (this.valueToPercent(this.maxValue /10) - this.valueToPercent(this.minValue /10)) + '%'
    },
